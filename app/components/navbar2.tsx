      ...
      <div className="w-full h-full flex justify-between items-center">
        ...
        <div className="hidden md:block md:ml-40 lg:ml-96">
          <ul className="flex gap-x-2 md:gap-x-5 mr-4">
            ...
            <Link className="text-[16px] font-medium" href="/shop">
              <li>Shop</li>
            </Link>
            <Link className="text-[16px] font-medium" href="/about">
              <li>About</li>
            </Link>
            <Link className="text-[16px] font-medium" href="/contact">
              <li>Contact</li>
            </Link>
            <Link className="text-[16px] font-medium" href="/blog">
              <li>Blog</li>
            </Link>
          </ul>
        </div>
        ...
        <div className="flex items-center justify-center lg:mr-28">
          <div className="flex items-center gap-2 md:gap-4">
            <Link href="/account">
              <FaRegUser className="h-[16px] md:h-[20px] w-[16px] md:w-[20px]" />
            </Link>
            ...
            <Link href="/carts">
              <FaCartShopping className="h-[16px] md:h-[20px] w-[16px] md:w-[20px]" />
            </Link>
          </div>
        </div>
      </div>
