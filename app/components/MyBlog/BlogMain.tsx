  ...
  return (
    <div className="mb-8 md:mb-0">
          ...
          <div className="w-full h-[750px] md:h-[794px]">
           ...
           <Image
            ...
            <div className="px-3 md:px-0">
              <h1 className="text-[24px] md:text-[30px] text-[#000000] font-medium font-[Poppins] mt-2">
                Going all-in with millennial design
              </h1>
              <p className="text-[15px] text-[#9F9F9F] font-normal font-[Poppins] mt-2">
            ...
            <h2 className="text-[16px] text-[#000000] font-normal font-[Poppins] border-b-2 border-gray-300 w-[100px] pb-3 mt-6 ml-3 md:ml-0">
              Read more
            </h2>
          </div>
          {/* post 02  */}
        ...
        <div className="w-full md:w-[390px] h-[900px] md:h-[1250px] flex flex-col items-center">
          ...
          <div className="w-full h-[500px] md:mb-10 flex flex-col items-center justify-start pt-6">
            ...
            <div className="flex items-center md:justify-center">
              <input
                type="text"
                className="w-[310px] h-[35px] md:h-[50px] border relative rounded-lg "
              />
            ...
            <div className="w-[300px] h-[350px] space-y-5 pt-6">
              <h1 className="text-[24px] text-black font-medium font-[Poppins]">
                Categories
              </h1>
          ...
          <div className="w-[350px] md:h-[650px] flex justify-center">
            <div className="w-[252px] md:h-[600px] bg-white">
              ...
              <div className="space-y-8">
                ...
                <div className="flex">
                  <Image
                    src="/images/blog/blog-1-unsplash.jpg"
                    alt="blog-1"
                    width={80}
                    height={80}
                  ...
                  <div className="w-[115px] ml-2">
                    <h1 className="text-[14px] text-black font-normal font-[Poppins]">
                      Going all-in with millennial design
                    </h1>
                    <p className="text-[12px] text-[#9F9F9F] font-normal font-[Poppins]">
                      03 Aug 2022
                    </p>
                  </div>
                </div>
                ...
                <div className="flex">
                  <Image
                    src="/images/blog/blog-2-unsplash.jpg"
                    alt="blog-1"
                    width={80}
                    height={80}
                    className=" rounded-lg"
                ...
                <div className="flex">
                  <Image
                    src="/images/blog/blog-3-unsplash.jpg"
                    alt="blog-1"
                    width={80}
                    height={80}
                    className=" rounded-lg"
                ...
                <div className="flex">
                  <Image
                    src="/images/blog/blog-4-unsplash.jpg"
                    alt="blog-1"
                    width={80}
                    height={80}
                    className=" rounded-lg"
                ...
                <div className="flex">
                  <Image
                    src="/images/blog/blog-5-unsplash.jpg"
                    alt="blog-1"
                    width={80}
                    height={80}
      ...
      <div className="flex justify-center items-center space-x-5 text-center mt-6 md:mt-0">
        <p className="text-[20px] font-[Poppins] font-normal w-[40px] md:w-[50px] h-[40px] md:h-[50px] bg-[#FBEBB5] rounded-md pt-2">
          1
        </p>

        <p className="text-[20px] font-[Poppins] font-normal  w-[40px] md:w-[50px] h-[40px] md:h-[50px] bg-[#FFF9E5] rounded-md pt-2">
          2
        </p>
        <p className="text-[20px] font-[Poppins] font-normal  w-[40px] md:w-[50px] h-[40px] md:h-[50px] bg-[#FFF9E5] rounded-md pt-2">
          3
        ...
        <p className="text-[20px] font-[Poppins] font-light w-[80px] md:w-[98px] h-[40px] md:h-[50px] bg-[#FFF9E5] rounded-md pt-3 cursor-pointer">
          Next
        </p>
      </div>
    </div>
